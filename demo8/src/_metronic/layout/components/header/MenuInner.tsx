  ...
  return (
    <>
      ...
      {/* <MenuInnerWithSub
          ...
          menuTrigger={`{default:'click', lg: 'hover'}`}
        > */}
      <MenuItem to='/crafted/widgets/stuprojects' title='Students Projects'  />
      <MenuItem to='/crafted/widgets/internee' title='Internee'  />
      <MenuItem to='/crafted/widgets/stutasks' title='Students Tasks'  />
      <MenuItem to='/crafted/widgets/leave' title='Leave'  />
      <MenuItem to='/crafted/widgets/accounts' title='Accounts'  />
      <MenuItem to='/crafted/widgets/teachers' title='Teacher'  />
      <MenuItem to='/crafted/widgets/knowledgebase' title='Knowledge base'  />
      <MenuItem to='/crafted/widgets/addteacher' title='Add Teacher'  />
      <MenuItem to='/crafted/widgets/universites' title='Universities'  />
      <MenuItem to='/crafted/widgets/settings' title='Settings'  />
      {/* </MenuInnerWithSub>
      </MenuInnerWithSub> */}
